...
class BaseConfigObjectResource(object):
    ...
    def get_object_by_name(self, url_path, name, path_params=None):
        get_object_list = partial(self._send_request, url_path=url_path, http_method=HTTPMethod.GET,
    ...
    def add_object(self, url_path, body_params, path_params=None, query_params=None, update_if_exists=False):
        ...
        if not existing_obj:
            return self._send_request(url_path=url_path, http_method=HTTPMethod.POST, body_params=body_params,
            ...
            return self._send_request(url_path=url_path + '/{objId}',
    ...
    def edit_object(self, url_path, body_params, path_params=None, query_params=None):
        existing_object = self._send_request(url_path=url_path, http_method=HTTPMethod.GET, path_params=path_params)
        ...
        if not existing_object:
            ...
            return self._send_request(url_path=url_path, http_method=HTTPMethod.PUT, body_params=body_params,
                                      path_params=path_params, query_params=query_params)
