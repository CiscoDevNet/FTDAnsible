...
ARG FTD_ANSIBLE_VERSION=v0.4.0
...
COPY ansible.cfg ${FTD_ANSIBLE_FOLDER}/ansible.cfg
COPY requirements.txt ${FTD_ANSIBLE_FOLDER}/requirements.txt
COPY ansible_collections /${FTD_ANSIBLE_FOLDER}/ansible_collections
