...
class ExportConfigJobHistoryResource(object):
    ...
    def getExportConfigJobHistoryList(self, params):
        query_params = dict_subset(params, ['filter', 'limit', 'offset', 'sort'])

        return self._conn.send_request(
            url_path='/jobs/exportconfigjob',
            http_method='GET',
            query_params=query_params,
        )

    def getExportConfigJobHistoryByName(self, params):
        search_params = params.copy()
        search_params['filter'] = 'name:%s' % params['name']
        item_generator = iterate_over_pageable_resource(self.getExportConfigJobHistoryList, search_params)
...
def main():
    ...
    try:
        ...
        resource = ExportConfigJobHistoryResource(conn)
