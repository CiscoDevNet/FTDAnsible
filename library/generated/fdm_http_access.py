...
DOCUMENTATION = """
---
module: fdm_http_access
short_description: Manages HTTPAccess objects on Cisco FTD devices with FDM
version_added: "2.7"
...
EXAMPLES = """
- name: Fetch HTTPAccess with a given name
  fdm_http_access:
    hostname: "https://127.0.0.1:8585"
    access_token: 'ACCESS_TOKEN'
    refresh_token: 'REFRESH_TOKEN'
    operation: "getHTTPAccessByName"
    name: "Ansible HTTPAccess"
"""
...
class HTTPAccessResource(object):
    ...
    @staticmethod
    @retry_on_token_expiration
    def getHTTPAccessByName(params):
        search_params = params.copy()
        search_params['filter'] = 'name:%s' % params['name']
        item_generator = iterate_over_pageable_resource(HTTPAccessResource.getHTTPAccessList, search_params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['editHTTPAccessList', 'getHTTPAccessList', 'getHTTPAccessByName'], required=True),
    ...
    try:
        method_to_call = getattr(HTTPAccessResource, params['operation'])
