...
DOCUMENTATION = """
---
module: fdm_job_history_deployment
short_description: Manages JobHistoryDeployment objects on Cisco FTD devices with FDM
version_added: "2.7"
...
class JobHistoryDeploymentResource(object):
    ...
    def deleteJobHistoryDeploymentByName(params):
        ...
        params = JobHistoryDeploymentResource.copy_identity_params(existing_object, params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['deleteJobHistoryDeployment', 'getJobHistoryDeployment', 'getJobHistoryDeploymentList', 'getJobHistoryDeploymentByName', 'deleteJobHistoryDeploymentByName'], required=True),
