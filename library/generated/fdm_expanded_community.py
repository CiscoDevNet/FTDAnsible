...
DOCUMENTATION = """
---
module: fdm_expanded_community
short_description: Manages ExpandedCommunity objects on Cisco FTD devices with FDM
version_added: "2.7"
...
EXAMPLES = """
- name: Fetch ExpandedCommunity with a given name
  fdm_expanded_community:
    hostname: "https://127.0.0.1:8585"
    access_token: 'ACCESS_TOKEN'
    refresh_token: 'REFRESH_TOKEN'
    operation: "getExpandedCommunityByName"
    name: "Ansible ExpandedCommunity"
"""
...
class ExpandedCommunityResource(object):
    ...
    @staticmethod
    @retry_on_token_expiration
    def getExpandedCommunityByName(params):
        search_params = params.copy()
        search_params['filter'] = 'name:%s' % params['name']
        item_generator = iterate_over_pageable_resource(ExpandedCommunityResource.getExpandedCommunityList, search_params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['addExpandedCommunityList', 'deleteExpandedCommunityList', 'editExpandedCommunityList', 'getExpandedCommunityList', 'getExpandedCommunityByName'], required=True),
    ...
    try:
        method_to_call = getattr(ExpandedCommunityResource, params['operation'])
