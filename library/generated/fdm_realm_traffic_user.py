...
DOCUMENTATION = """
---
module: fdm_realm_traffic_user
short_description: Manages RealmTrafficUser objects on Cisco FTD devices with FDM
version_added: "2.7"
...
class RealmTrafficUserResource(object):
    ...
    @staticmethod
    @retry_on_token_expiration
    def getRealmTrafficUserByName(params):
        search_params = params.copy()
        search_params['filter'] = 'name:%s' % params['name']
        item_generator = iterate_over_pageable_resource(RealmTrafficUserResource.getRealmTrafficUserList, search_params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['getRealmTrafficUser', 'getRealmTrafficUserList', 'getRealmTrafficUserByName'], required=True),
    ...
    try:
        method_to_call = getattr(RealmTrafficUserResource, params['operation'])
