...
class SmartAgentStatusResource(object):
    ...
    def getSmartAgentStatus(self, params):
        path_params = dict_subset(params, ['objId'])

        return self._conn.send_request(
            url_path='/license/smartagentstatuses/{objId}',
            http_method='GET',
            path_params=path_params,
        )

    def getSmartAgentStatusList(self, params):
        query_params = dict_subset(params, ['filter', 'limit', 'offset', 'sort'])

        return self._conn.send_request(
            url_path='/license/smartagentstatuses',
            http_method='GET',
            query_params=query_params,
        )

    def getSmartAgentStatusByName(self, params):
        search_params = params.copy()
        search_params['filter'] = 'name:%s' % params['name']
        item_generator = iterate_over_pageable_resource(self.getSmartAgentStatusList, search_params)
...
def main():
    ...
    try:
        ...
        resource = SmartAgentStatusResource(conn)
