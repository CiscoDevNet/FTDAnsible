...
DOCUMENTATION = """
---
module: fdm_any_connect_group_policy
short_description: Manages AnyConnectGroupPolicy objects on Cisco FTD devices with FDM
version_added: "2.7"
...
class AnyConnectGroupPolicyResource(object):
    ...
    def deleteAnyConnectGroupPolicyByName(params):
        ...
        params = AnyConnectGroupPolicyResource.copy_identity_params(existing_object, params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['deleteAnyConnectGroupPolicy', 'getAnyConnectGroupPolicy', 'getAnyConnectGroupPolicyList', 'getAnyConnectGroupPolicyByName', 'deleteAnyConnectGroupPolicyByName'], required=True),
