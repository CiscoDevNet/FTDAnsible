...
DOCUMENTATION = """
---
module: fdm_dns_server_group
short_description: Manages DNSServerGroup objects on Cisco FTD devices with FDM
version_added: "2.7"
    ...
    def upsertDNSServerGroup(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = DNSServerGroupResource.copy_identity_params(existing_object, params)
