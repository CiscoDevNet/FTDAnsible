...
DOCUMENTATION = """
---
module: fdm_standard_community
short_description: Manages StandardCommunity objects on Cisco FTD devices with FDM
version_added: "2.7"
...
EXAMPLES = """
- name: Fetch StandardCommunity with a given name
  fdm_standard_community:
    hostname: "https://127.0.0.1:8585"
    access_token: 'ACCESS_TOKEN'
    refresh_token: 'REFRESH_TOKEN'
    operation: "getStandardCommunityByName"
    name: "Ansible StandardCommunity"
"""
...
class StandardCommunityResource(object):
    ...
    @staticmethod
    @retry_on_token_expiration
    def getStandardCommunityByName(params):
        search_params = params.copy()
        search_params['filter'] = 'name:%s' % params['name']
        item_generator = iterate_over_pageable_resource(StandardCommunityResource.getStandardCommunityList, search_params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['addStandardCommunityList', 'deleteStandardCommunityList', 'editStandardCommunityList', 'getStandardCommunityList', 'getStandardCommunityByName'], required=True),
    ...
    try:
        method_to_call = getattr(StandardCommunityResource, params['operation'])
