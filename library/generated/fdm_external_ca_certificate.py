...
DOCUMENTATION = """
---
module: fdm_external_ca_certificate
short_description: Manages ExternalCACertificate objects on Cisco FTD devices with FDM
version_added: "2.7"
    ...
    def upsertExternalCACertificate(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = ExternalCACertificateResource.copy_identity_params(existing_object, params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['addExternalCACertificate', 'deleteExternalCACertificate', 'editExternalCACertificate', 'getExternalCACertificate', 'getExternalCACertificateList', 'getExternalCACertificateByName', 'upsertExternalCACertificate', 'editExternalCACertificateByName', 'deleteExternalCACertificateByName'], required=True),
