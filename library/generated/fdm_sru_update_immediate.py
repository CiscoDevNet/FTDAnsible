...
DOCUMENTATION = """
---
module: fdm_sru_update_immediate
short_description: Manages SRUUpdateImmediate objects on Cisco FTD devices with FDM
version_added: "2.7"
    ...
    def upsertSRUUpdateImmediate(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = SRUUpdateImmediateResource.copy_identity_params(existing_object, params)
