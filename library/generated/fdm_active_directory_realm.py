...
DOCUMENTATION = """
---
module: fdm_active_directory_realm
short_description: Manages ActiveDirectoryRealm objects on Cisco FTD devices with FDM
version_added: "2.7"
...
options:
  ...
  adPrimaryDomain
    description:
      - A mandatory Unicode alphanumeric string containing fully qualified Active Directory domain name that the device should join. For example, example.com<br>Field level constraints: cannot be null, cannot have HTML, must match pattern ^((?!;).)*$. (Note: Additional constraints might exist)
  baseDN
    description:
    ...
    def upsertActiveDirectoryRealm(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = ActiveDirectoryRealmResource.copy_identity_params(existing_object, params)
