...
DOCUMENTATION = """
---
module: fdm_internal_ca_certificate
short_description: Manages InternalCACertificate objects on Cisco FTD devices with FDM
version_added: "2.7"
    ...
    def upsertInternalCACertificate(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = InternalCACertificateResource.copy_identity_params(existing_object, params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['addInternalCACertificate', 'deleteInternalCACertificate', 'editInternalCACertificate', 'getInternalCACertificate', 'getInternalCACertificateList', 'getInternalCACertificateByName', 'upsertInternalCACertificate', 'editInternalCACertificateByName', 'deleteInternalCACertificateByName'], required=True),
