...
class SpecialRealmTrafficUserResource(object):
    ...
    def getSpecialRealmTrafficUser(self, params):
        path_params = dict_subset(params, ['objId', 'parentId'])

        return self._conn.send_request(
            url_path='/object/specialrealms/{parentId}/trafficusers/{objId}',
            http_method='GET',
            path_params=path_params,
        )

    def getSpecialRealmTrafficUserList(self, params):
        path_params = dict_subset(params, ['parentId'])
        query_params = dict_subset(params, ['filter', 'limit', 'offset', 'sort'])

        return self._conn.send_request(
            url_path='/object/specialrealms/{parentId}/trafficusers',
            http_method='GET',
            path_params=path_params,
            query_params=query_params,
        )

    def getSpecialRealmTrafficUserByName(self, params):
        search_params = params.copy()
        search_params['filter'] = 'name:%s' % params['name']
        item_generator = iterate_over_pageable_resource(self.getSpecialRealmTrafficUserList, search_params)
...
def main():
    ...
    try:
        ...
        resource = SpecialRealmTrafficUserResource(conn)
