...
DOCUMENTATION = """
---
module: fdm_vdb_update_schedule
short_description: Manages VDBUpdateSchedule objects on Cisco FTD devices with FDM
version_added: "2.7"
    ...
    def upsertVDBUpdateSchedule(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = VDBUpdateScheduleResource.copy_identity_params(existing_object, params)
