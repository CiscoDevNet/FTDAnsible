...
DOCUMENTATION = """
---
module: fdm_restore_immediate
short_description: Manages RestoreImmediate objects on Cisco FTD devices with FDM
version_added: "2.7"
...
class RestoreImmediateResource(object):
    ...
    def addRestoreImmediate(params):
        body_params = dict_subset(params, ['version', 'scheduleType', 'user', 'forceOperation', 'jobHistoryUuid', 'ipAddress', 'archiveName', 'preserveArchive', 'jobName', 'id', 'type'])
