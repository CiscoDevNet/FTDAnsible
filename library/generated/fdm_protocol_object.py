...
DOCUMENTATION = """
---
module: fdm_protocol_object
short_description: Manages ProtocolObject objects on Cisco FTD devices with FDM
version_added: "2.7"
...
class ProtocolObjectResource(object):
    ...
    def addProtocolObject(params):
        body_params = dict_subset(params, ['version', 'name', 'description', 'isSystemDefined', 'protocol', 'id', 'type'])
    ...
    def upsertProtocolObject(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = ProtocolObjectResource.copy_identity_params(existing_object, params)
