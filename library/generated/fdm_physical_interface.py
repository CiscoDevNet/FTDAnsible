...
DOCUMENTATION = """
---
module: fdm_physical_interface
short_description: Manages PhysicalInterface objects on Cisco FTD devices with FDM
version_added: "2.7"
...
class PhysicalInterfaceResource(object):
    ...
    def editPhysicalInterfaceByName(params):
        ...
        params = PhysicalInterfaceResource.copy_identity_params(existing_object, params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['editPhysicalInterface', 'getPhysicalInterface', 'getPhysicalInterfaceList', 'getPhysicalInterfaceByName', 'editPhysicalInterfaceByName'], required=True),
