...
DOCUMENTATION = """
---
module: fdm_as_path_list
short_description: Manages ASPathList objects on Cisco FTD devices with FDM
version_added: "2.7"
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['getASPathListList', 'getASPathListByName'], required=True),
