...
---
module: fdm_as_path
short_description: Manages ASPath objects on Cisco FTD devices with FDM
version_added: "2.7"
...
EXAMPLES = """
- name: Fetch ASPath with a given name
  fdm_as_path:
    hostname: "https://127.0.0.1:8585"
    access_token: 'ACCESS_TOKEN'
    refresh_token: 'REFRESH_TOKEN'
    operation: "getASPathByName"
    name: "Ansible ASPath"
"""
...
class ASPathResource(object):
    ...
    @staticmethod
    @retry_on_token_expiration
    def getASPathByName(params):
        search_params = params.copy()
        search_params['filter'] = 'name:%s' % params['name']
        item_generator = iterate_over_pageable_resource(ASPathResource.getASPathList, search_params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['addASPathList', 'deleteASPathList', 'editASPathList', 'getASPathList', 'getASPathByName'], required=True),
    ...
    try:
        method_to_call = getattr(ASPathResource, params['operation'])
