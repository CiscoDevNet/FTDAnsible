...
DOCUMENTATION = """
---
module: fdm_deployment_data
short_description: Manages DeploymentData objects on Cisco FTD devices with FDM
version_added: "2.7"
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['getDeploymentData'], required=True),
