...
DOCUMENTATION = """
---
module: fdm_ipv4_prefix_list
short_description: Manages IPV4PrefixList objects on Cisco FTD devices with FDM
version_added: "2.7"
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['getIPV4PrefixListList', 'getIPV4PrefixListByName'], required=True),
