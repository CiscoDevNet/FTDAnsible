...
DOCUMENTATION = """
---
module: fdm_ha_failover_configuration
short_description: Manages HAFailoverConfiguration objects on Cisco FTD devices with FDM
version_added: "2.7"
...
class HAFailoverConfigurationResource(object):
    ...
    def editHAFailoverConfigurationByName(params):
        ...
        params = HAFailoverConfigurationResource.copy_identity_params(existing_object, params)
