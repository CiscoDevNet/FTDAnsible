...
DOCUMENTATION = """
---
module: fdm_backup_immediate
short_description: Manages BackupImmediate objects on Cisco FTD devices with FDM
version_added: "2.7"
    ...
    def upsertBackupImmediate(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = BackupImmediateResource.copy_identity_params(existing_object, params)
