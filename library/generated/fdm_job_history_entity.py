...
DOCUMENTATION = """
---
module: fdm_job_history_entity
short_description: Manages JobHistoryEntity objects on Cisco FTD devices with FDM
version_added: "2.7"
...
class JobHistoryEntityResource(object):
    ...
    def deleteJobHistoryEntityByName(params):
        ...
        params = JobHistoryEntityResource.copy_identity_params(existing_object, params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['deleteJobHistoryEntity', 'getJobHistoryEntity', 'getJobHistoryEntityList', 'getJobHistoryEntityByName', 'deleteJobHistoryEntityByName'], required=True),
