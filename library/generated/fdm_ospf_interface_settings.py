...
DOCUMENTATION = """
---
module: fdm_ospf_interface_settings
short_description: Manages OSPFInterfaceSettings objects on Cisco FTD devices with FDM
version_added: "2.7"
    ...
    def upsertOSPFInterfaceSettings(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = OSPFInterfaceSettingsResource.copy_identity_params(existing_object, params)
