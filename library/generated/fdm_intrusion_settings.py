...
DOCUMENTATION = """
---
module: fdm_intrusion_settings
short_description: Manages IntrusionSettings objects on Cisco FTD devices with FDM
version_added: "2.7"
...
class IntrusionSettingsResource(object):
    ...
    def editIntrusionSettingsByName(params):
        ...
        params = IntrusionSettingsResource.copy_identity_params(existing_object, params)
