...
DOCUMENTATION = """
---
module: fdm_standard_community_list
short_description: Manages StandardCommunityList objects on Cisco FTD devices with FDM
version_added: "2.7"
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['getStandardCommunityListList', 'getStandardCommunityListByName'], required=True),
