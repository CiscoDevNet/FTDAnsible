...
DOCUMENTATION = """
---
module: fdm_smart_agent_status
short_description: Manages SmartAgentStatus objects on Cisco FTD devices with FDM
version_added: "2.7"
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['getSmartAgentStatus', 'getSmartAgentStatusList', 'getSmartAgentStatusByName'], required=True),
