...
DOCUMENTATION = """
---
module: fdm_sub_interface
short_description: Manages SubInterface objects on Cisco FTD devices with FDM
version_added: "2.7"
    ...
    def upsertSubInterface(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = SubInterfaceResource.copy_identity_params(existing_object, params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['addSubInterface', 'deleteSubInterface', 'editSubInterface', 'getSubInterface', 'getSubInterfaceList', 'getSubInterfaceByName', 'upsertSubInterface', 'editSubInterfaceByName', 'deleteSubInterfaceByName'], required=True),
