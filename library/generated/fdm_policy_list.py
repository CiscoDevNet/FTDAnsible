...
DOCUMENTATION = """
---
module: fdm_policy_list
short_description: Manages PolicyList objects on Cisco FTD devices with FDM
version_added: "2.7"
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['getPolicyListList', 'getPolicyListByName'], required=True),
