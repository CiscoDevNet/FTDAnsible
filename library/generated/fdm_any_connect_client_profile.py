...
DOCUMENTATION = """
---
module: fdm_any_connect_client_profile
short_description: Manages AnyConnectClientProfile objects on Cisco FTD devices with FDM
version_added: "2.7"
...
- name: Fetch AnyConnectClientProfile with a given name
  fdm_any_connect_client_profile:
...
class AnyConnectClientProfileResource(object):
    ...
    def addAnyConnectClientProfile(params):
        body_params = dict_subset(params, ['version', 'name', 'description', 'diskFileName', 'md5Checksum', 'id', 'type'])
    ...
    def upsertAnyConnectClientProfile(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = AnyConnectClientProfileResource.copy_identity_params(existing_object, params)
