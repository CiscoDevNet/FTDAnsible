...
DOCUMENTATION = """
---
module: fdm_s_to_s_connection_profile
short_description: Manages SToSConnectionProfile objects on Cisco FTD devices with FDM
version_added: "2.7"
    ...
    def upsertSToSConnectionProfile(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = SToSConnectionProfileResource.copy_identity_params(existing_object, params)
