...
DOCUMENTATION = """
---
module: fdm_ipv6_prefix_list
short_description: Manages IPV6PrefixList objects on Cisco FTD devices with FDM
version_added: "2.7"
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['getIPV6PrefixListList', 'getIPV6PrefixListByName'], required=True),
