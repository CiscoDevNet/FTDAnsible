...
DOCUMENTATION = """
---
module: fdm_device_hostname
short_description: Manages DeviceHostname objects on Cisco FTD devices with FDM
version_added: "2.7"
...
class DeviceHostnameResource(object):
    ...
    def editDeviceHostnameByName(params):
        ...
        params = DeviceHostnameResource.copy_identity_params(existing_object, params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['editDeviceHostname', 'getDeviceHostname', 'getDeviceHostnameList', 'getDeviceHostnameByName', 'editDeviceHostnameByName'], required=True),
