...
class SecurityIntelligencePolicyResource(object):
    ...
    def editSecurityIntelligencePolicy(self, params):
        path_params = dict_subset(params, ['objId'])
        body_params = dict_subset(params, ['id', 'logEnabled', 'name', 'securityIntelligenceNetworkPolicy', 'securityIntelligenceURLPolicy', 'syslogServer', 'type', 'version'])

        return self._conn.send_request(
            url_path='/policy/securityintelligencepolicies/{objId}',
            http_method='PUT',
            body_params=body_params,
            path_params=path_params,
        )

    def getSecurityIntelligencePolicy(self, params):
        path_params = dict_subset(params, ['objId'])
    ...
    def getSecurityIntelligencePolicyList(self, params):
        query_params = dict_subset(params, ['filter', 'limit', 'offset', 'sort'])

        return self._conn.send_request(
            url_path='/policy/securityintelligencepolicies',
            http_method='GET',
            query_params=query_params,
        )

    def getSecurityIntelligencePolicyByName(self, params):
        search_params = params.copy()
        search_params['filter'] = 'name:%s' % params['name']
        item_generator = iterate_over_pageable_resource(self.getSecurityIntelligencePolicyList, search_params)
        return next(item for item in item_generator if item['name'] == params['name'])

    def editSecurityIntelligencePolicyByName(self, params):
        existing_object = self.getSecurityIntelligencePolicyByName(params)
        params = copy_identity_properties(existing_object, params)
        return self.editSecurityIntelligencePolicy(params)
...
def main():
    ...
    try:
        ...
        resource = SecurityIntelligencePolicyResource(conn)
