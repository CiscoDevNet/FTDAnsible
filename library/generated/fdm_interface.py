...
DOCUMENTATION = """
---
module: fdm_interface
short_description: Manages Interface objects on Cisco FTD devices with FDM
version_added: "2.7"
...
def main():
    ...
    try:
        method_to_call = getattr(InterfaceResource, params['operation'])
