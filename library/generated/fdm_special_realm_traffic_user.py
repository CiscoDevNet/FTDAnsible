...
DOCUMENTATION = """
---
module: fdm_special_realm_traffic_user
short_description: Manages SpecialRealmTrafficUser objects on Cisco FTD devices with FDM
version_added: "2.7"
...
- name: Fetch SpecialRealmTrafficUser with a given name
  fdm_special_realm_traffic_user:
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['getSpecialRealmTrafficUser', 'getSpecialRealmTrafficUserList', 'getSpecialRealmTrafficUserByName'], required=True),
