...
DOCUMENTATION = """
---
module: fdm_data_interface_management_access
short_description: Manages DataInterfaceManagementAccess objects on Cisco FTD devices with FDM
version_added: "2.7"
...
- name: Fetch DataInterfaceManagementAccess with a given name
  fdm_data_interface_management_access:
    ...
    def upsertDataInterfaceManagementAccess(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = DataInterfaceManagementAccessResource.copy_identity_params(existing_object, params)
