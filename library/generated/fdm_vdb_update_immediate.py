...
DOCUMENTATION = """
---
module: fdm_vdb_update_immediate
short_description: Manages VDBUpdateImmediate objects on Cisco FTD devices with FDM
version_added: "2.7"
    ...
    def upsertVDBUpdateImmediate(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = VDBUpdateImmediateResource.copy_identity_params(existing_object, params)
