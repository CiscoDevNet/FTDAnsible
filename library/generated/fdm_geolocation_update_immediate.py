...
DOCUMENTATION = """
---
module: fdm_geolocation_update_immediate
short_description: Manages GeolocationUpdateImmediate objects on Cisco FTD devices with FDM
version_added: "2.7"
...
- name: Fetch GeolocationUpdateImmediate with a given name
  fdm_geolocation_update_immediate:
    ...
    def upsertGeolocationUpdateImmediate(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = GeolocationUpdateImmediateResource.copy_identity_params(existing_object, params)
