...
short_description: Manages Deployment jobs on Cisco FTD devices.
description:
...
class DeploymentResource(object):
    ...
    def start_job(self):
        return self._conn.send_request(
            url_path='/operational/deploy',
            http_method='POST',
        )['id']

    def fetch_job_status(self, job_id):
        return self._conn.send_request(
            url_path='/operational/deploy/{objId}',
            http_method='GET',
...
def main():
    ...
    try:
        ...
        resource = DeploymentResource(conn)
