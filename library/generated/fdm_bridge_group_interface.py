...
DOCUMENTATION = """
---
module: fdm_bridge_group_interface
short_description: Manages BridgeGroupInterface objects on Cisco FTD devices with FDM
version_added: "2.7"
    ...
    def upsertBridgeGroupInterface(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = BridgeGroupInterfaceResource.copy_identity_params(existing_object, params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['addBridgeGroupInterface', 'deleteBridgeGroupInterface', 'editBridgeGroupInterface', 'getBridgeGroupInterface', 'getBridgeGroupInterfaceList', 'getBridgeGroupInterfaceByName', 'upsertBridgeGroupInterface', 'editBridgeGroupInterfaceByName', 'deleteBridgeGroupInterfaceByName'], required=True),
