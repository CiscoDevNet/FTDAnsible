...
DOCUMENTATION = """
---
module: ftd_interface_info
short_description: Manages InterfaceInfo objects on Cisco FTD devices
version_added: "2.7"
...
class InterfaceInfoResource(object):
    
    @staticmethod
    @retry_on_token_expiration
    def getInterfaceInfo(params):
        path_params = dict_subset(params, ['objId'])

        url = construct_url(params['hostname'], '/operational/interfaceinfo/{objId}', path_params=path_params)
        request_params = dict(
...
def main():
    fields = dict(
        ...
        operation=dict(type='str', choices=['getInterfaceInfo'], required=True),
    ...
    try:
        method_to_call = getattr(InterfaceInfoResource, params['operation'])
