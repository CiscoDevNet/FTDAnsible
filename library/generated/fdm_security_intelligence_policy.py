...
DOCUMENTATION = """
---
module: fdm_security_intelligence_policy
short_description: Manages SecurityIntelligencePolicy objects on Cisco FTD devices with FDM
version_added: "2.7"
...
- name: Fetch SecurityIntelligencePolicy with a given name
  fdm_security_intelligence_policy:
...
class SecurityIntelligencePolicyResource(object):
    ...
    def editSecurityIntelligencePolicyByName(params):
        ...
        params = SecurityIntelligencePolicyResource.copy_identity_params(existing_object, params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['editSecurityIntelligencePolicy', 'getSecurityIntelligencePolicy', 'getSecurityIntelligencePolicyList', 'getSecurityIntelligencePolicyByName', 'editSecurityIntelligencePolicyByName'], required=True),
