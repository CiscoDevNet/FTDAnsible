...
DOCUMENTATION = """
---
module: fdm_security_intelligence_update_feeds_immediate
short_description: Manages SecurityIntelligenceUpdateFeedsImmediate objects on Cisco FTD devices with FDM
version_added: "2.7"
...
- name: Fetch SecurityIntelligenceUpdateFeedsImmediate with a given name
  fdm_security_intelligence_update_feeds_immediate:
    ...
    def upsertSecurityIntelligenceUpdateFeedsImmediate(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = SecurityIntelligenceUpdateFeedsImmediateResource.copy_identity_params(existing_object, params)
