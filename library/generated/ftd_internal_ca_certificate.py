...
DOCUMENTATION = """
---
module: ftd_internal_ca_certificate
short_description: Manages InternalCACertificate objects on Cisco FTD devices
version_added: "2.7"
...
def main():
    fields = dict(
        ...
        operation=dict(type='str', choices=['getInternalCACertificateList', 'getInternalCACertificateByName'], required=True),
