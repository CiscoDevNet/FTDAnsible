...
DOCUMENTATION = """
---
module: fdm_manual_nat_rule
short_description: Manages ManualNatRule objects on Cisco FTD devices with FDM
version_added: "2.7"
    ...
    def upsertManualNatRule(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = ManualNatRuleResource.copy_identity_params(existing_object, params)
