...
DOCUMENTATION = """
---
module: fdm_ha_configuration
short_description: Manages HAConfiguration objects on Cisco FTD devices with FDM
version_added: "2.7"
...
class HAConfigurationResource(object):
    ...
    def editHAConfigurationByName(params):
        ...
        params = HAConfigurationResource.copy_identity_params(existing_object, params)
