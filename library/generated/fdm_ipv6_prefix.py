...
DOCUMENTATION = """
---
module: fdm_ipv6_prefix
short_description: Manages IPV6Prefix objects on Cisco FTD devices with FDM
version_added: "2.7"
...
EXAMPLES = """
- name: Fetch IPV6Prefix with a given name
  fdm_ipv6_prefix:
    hostname: "https://127.0.0.1:8585"
    access_token: 'ACCESS_TOKEN'
    refresh_token: 'REFRESH_TOKEN'
    operation: "getIPV6PrefixByName"
    name: "Ansible IPV6Prefix"
"""
...
class IPV6PrefixResource(object):
    ...
    @staticmethod
    @retry_on_token_expiration
    def getIPV6PrefixByName(params):
        search_params = params.copy()
        search_params['filter'] = 'name:%s' % params['name']
        item_generator = iterate_over_pageable_resource(IPV6PrefixResource.getIPV6PrefixList, search_params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['addIPV6PrefixList', 'deleteIPV6PrefixList', 'editIPV6PrefixList', 'getIPV6PrefixList', 'getIPV6PrefixByName'], required=True),
    ...
    try:
        method_to_call = getattr(IPV6PrefixResource, params['operation'])
