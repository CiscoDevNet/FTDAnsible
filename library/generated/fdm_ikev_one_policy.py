...
DOCUMENTATION = """
---
module: fdm_ikev_one_policy
short_description: Manages IkevOnePolicy objects on Cisco FTD devices with FDM
version_added: "2.7"
    ...
    def upsertIkevOnePolicy(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = IkevOnePolicyResource.copy_identity_params(existing_object, params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['addIkevOnePolicy', 'deleteIkevOnePolicy', 'editIkevOnePolicy', 'getIkevOnePolicy', 'getIkevOnePolicyList', 'getIkevOnePolicyByName', 'upsertIkevOnePolicy', 'editIkevOnePolicyByName', 'deleteIkevOnePolicyByName'], required=True),
