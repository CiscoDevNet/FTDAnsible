...
DOCUMENTATION = """
---
module: fdm_dhcp_server_container
short_description: Manages DHCPServerContainer objects on Cisco FTD devices with FDM
version_added: "2.7"
...
class DHCPServerContainerResource(object):
    ...
    def editDHCPServerContainerByName(params):
        ...
        params = DHCPServerContainerResource.copy_identity_params(existing_object, params)
