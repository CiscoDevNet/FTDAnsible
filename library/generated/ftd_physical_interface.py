...
class PhysicalInterfaceResource(object):
    ...
    def editPhysicalInterface(self, params):
        ...
        return self._conn.send_request(
            url_path='/devices/default/interfaces/{objId}',
            http_method='PUT',
            body_params=body_params,
            path_params=path_params,
        )

    def getPhysicalInterface(self, params):
        path_params = dict_subset(params, ['objId'])
    ...
    def getPhysicalInterfaceList(self, params):
        query_params = dict_subset(params, ['filter', 'limit', 'offset', 'sort'])

        return self._conn.send_request(
            url_path='/devices/default/interfaces',
            http_method='GET',
            query_params=query_params,
        )

    def getPhysicalInterfaceByName(self, params):
        search_params = params.copy()
        search_params['filter'] = 'name:%s' % params['name']
        item_generator = iterate_over_pageable_resource(self.getPhysicalInterfaceList, search_params)
        return next(item for item in item_generator if item['name'] == params['name'])

    def editPhysicalInterfaceByName(self, params):
        existing_object = self.getPhysicalInterfaceByName(params)
        params = copy_identity_properties(existing_object, params)
        return self.editPhysicalInterface(params)
...
def main():
    ...
    try:
        ...
        resource = PhysicalInterfaceResource(conn)
