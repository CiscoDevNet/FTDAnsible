...
class DeviceHostnameResource(object):
    ...
    def editDeviceHostname(self, params):
        path_params = dict_subset(params, ['objId'])
        body_params = dict_subset(params, ['hostname', 'id', 'name', 'type', 'version'])

        return self._conn.send_request(
            url_path='/devicesettings/default/devicehostnames/{objId}',
            http_method='PUT',
            body_params=body_params,
            path_params=path_params,
        )

    def getDeviceHostname(self, params):
        path_params = dict_subset(params, ['objId'])
    ...
    def getDeviceHostnameList(self, params):
        query_params = dict_subset(params, ['filter', 'limit', 'offset', 'sort'])

        return self._conn.send_request(
            url_path='/devicesettings/default/devicehostnames',
            http_method='GET',
            query_params=query_params,
        )

    def getDeviceHostnameByName(self, params):
        search_params = params.copy()
        search_params['filter'] = 'name:%s' % params['name']
        item_generator = iterate_over_pageable_resource(self.getDeviceHostnameList, search_params)
        return next(item for item in item_generator if item['name'] == params['name'])

    def editDeviceHostnameByName(self, params):
        existing_object = self.getDeviceHostnameByName(params)
        params = copy_identity_properties(existing_object, params)
        return self.editDeviceHostname(params)
...
def main():
    ...
    try:
        ...
        resource = DeviceHostnameResource(conn)
