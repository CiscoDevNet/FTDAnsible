...
DOCUMENTATION = """
---
module: fdm_ikev_two_proposal
short_description: Manages IkevTwoProposal objects on Cisco FTD devices with FDM
version_added: "2.7"
...
class IkevTwoProposalResource(object):
    ...
    def addIkevTwoProposal(params):
        body_params = dict_subset(params, ['version', 'name', 'encryptionTypes', 'integrityTypes', 'summaryLabel', 'cryptoRestricted', 'defaultAssignable', 'id', 'isSystemDefined', 'type'])
    ...
    def upsertIkevTwoProposal(params):
        ...
        try:
            ...
            if is_duplicate_name_error(e):
                ...
                params = IkevTwoProposalResource.copy_identity_params(existing_object, params)
...
def main():
    fields = dict(
        ...
        operation=dict(choices=['addIkevTwoProposal', 'deleteIkevTwoProposal', 'editIkevTwoProposal', 'getIkevTwoProposal', 'getIkevTwoProposalList', 'getIkevTwoProposalByName', 'upsertIkevTwoProposal', 'editIkevTwoProposalByName', 'deleteIkevTwoProposalByName'], required=True),
